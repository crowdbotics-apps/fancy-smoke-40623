"""
Django settings for fancy_smoke_40623 project.
...
ROOT_URLCONF = 'fancy_smoke_40623.urls'
...
WSGI_APPLICATION = 'fancy_smoke_40623.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_smoke_40623 API",
    "DESCRIPTION": "API documentation for fancy_smoke_40623 App",
    "VERSION": "v1",
}
